    ...
    <div className="space-y-6">
      ...
      {selectedList ? (
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <h2 className={`text-lg font-bold ${
                  ...
                  {selectedList.name} ({listLeads.length} leads)
                </h2>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-3 py-1 text-xs rounded-lg bg-red-600 text-white hover:bg-red-700 transition-colors"
                    >
        ...
        <div className={`p-8 rounded-xl border text-center ${
          ...
          <p className={theme === 'gold' ? 'text-gray-400' : 'text-gray-600'}>
            Choose a list from the dropdown above to manage its leads
          </p>
        </div>
      )}
      {/* Create List Modal */}
