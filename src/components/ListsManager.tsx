              ...
              {filteredDiscoveredLeads.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {filteredDiscoveredLeads.map((lead) => (
                    <div
                      key={lead.id}
                      className={`p-4 rounded-lg border transition-all hover:shadow-md overflow-hidden ${
                        theme === 'gold'
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mb-3 gap-2">
                        ...
                        <span className={`text-xs px-2 py-1 rounded whitespace-nowrap flex-shrink-0 ${
                          ...
                          {lead.source_slug && lead.source_slug.length > 10 ? `${lead.source_slug.substring(0, 10)}...` : lead.source_slug}
                        </span>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        {lead.title && (
                          <div className={`flex items-start text-sm ${
                            ...
                            <span className="break-words">
                              {lead.title.length > 50 ? `${lead.title.substring(0, 50)}...` : lead.title}
                            </span>
                          </div>
                        )}
                        ...
                        {lead.company && (
                          <div className={`flex items-start text-sm ${
                            ...
                            <span className="break-words">
                              {lead.company.length > 40 ? `${lead.company.substring(0, 40)}...` : lead.company}
                            </span>
                          </div>
                        )}
                        ...
                        {lead.email && (
                          <div className={`flex items-start text-sm ${
                            ...
                            <span className="break-all text-xs">
                              {lead.email.length > 30 ? `${lead.email.substring(0, 30)}...` : lead.email}
                            </span>
                          </div>
                        )}
                        ...
                        {lead.linkedin_url && (
                          ...
                          >
                            <ExternalLink className="h-3 w-3 mr-2 mt-0.5 flex-shrink-0" />
                      ...
                      <div className="mt-4">
                        <select
                          ...
                          className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 truncate ${
                            theme === 'gold'
