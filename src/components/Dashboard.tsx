                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            <div className={`text-xs ${
                              ...
                              {campaigns.find(c => c.id === metric.campaign_id)?.status || 'draft'}
                            </div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="space-y-1">
                          <div className={`text-sm font-medium ${
                            ...
                            {metric.total_leads} leads
                          </div>
                          <div className={`text-xs ${
                            theme === 'gold' ? 'text-gray-400' : 'text-gray-600'
                          }`}>
                            {metric.calls_made + metric.sms_sent + metric.whatsapp_sent + metric.emails_sent} contacted
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
