...
export function ListCleaningModal({ listId, listName, onClose, onSuccess }: ListCleaningModalProps) {
  ...
  const [avatarVerificationResult, setAvatarVerificationResult] = useState<{
    success: boolean;
    message: string;
    summary?: any;
  } | null>(null);
                ...
                <div className={`p-6 rounded-lg border ${
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      {
                        key: 'verifyAvatar',
                        label: 'Verify Avatar Match',
                        description: 'Score leads against your ideal client avatar using AI',
                        count: 0,
                        icon: Target
                      }
                    ].map((option) => {
